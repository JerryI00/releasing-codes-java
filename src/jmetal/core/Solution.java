...
public class Solution implements Serializable {
	...
	/**
	 * Stores the original objective values before translation
	 */
	private double[] nonTranslateObjective_;
	
	/**
	 * Judge whether a solution is changed or not
	 */
	...
	public Solution(int numberOfObjectives) {
		...
		nonTranslateObjective_ = new double[numberOfObjectives];
	}
	...
	public Solution(Problem problem) throws ClassNotFoundException {
		...
		nonTranslateObjective_ = new double[numberOfObjectives_];
	...
	public Solution(Solution solution) {
		...
		for (int i = 0; i < objective_.length; i++) {
			...
			nonTranslateObjective_[i] = solution.getNonTranslateObjective(i);
		} // for
			// <-
		...
		translated_					 = solution.isTranslated();
	} // Solution
	...
	public void setNonTranslateObjecitve(int i, double value) {
		nonTranslateObjective_[i] = value;
	}
	...
	public double getNonTranslateObjective(int i) {
		return nonTranslateObjective_[i];
	}
