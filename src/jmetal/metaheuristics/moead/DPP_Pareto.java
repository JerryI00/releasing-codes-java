 ...
 * DPP_Pareto.java
 * 
 * This is main implementation of ND/DPP.
 * 
 * Author:
...
public class DPP_Pareto extends Algorithm {
	 ...
	 */
	public DPP_Pareto(Problem problem) {
		super(problem);
...
//		functionType_ = "_PBI";
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		archive_pop  = new SolutionSet(populationSize_ + 1);
...
//				addIndiv(indiv);
	 ...
	 * @return
	 */
	public double calculateDistance(Solution individual, double[] lambda, double[] z_, double[] nz_) {
		double scale;
		double distance;
