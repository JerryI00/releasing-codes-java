...
//  
//  Note: This is a fast implementation of steady-state NSGA-II with efficient non-domination level update (ENLU) method. The basic framework of 
//        steady-state NSGA-II keeps the same, except the maintenance of the non-domination level structure of the population.
//
//	Reference:
